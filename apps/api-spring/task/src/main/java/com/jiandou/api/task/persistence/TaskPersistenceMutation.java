...
public final class TaskPersistenceMutation {
    ...
    private final List<Map<String, Object>> requestLogRows = new ArrayList<>();
     ...
     * @return 处理结果
     */
    public TaskPersistenceMutation addRequestLog(Map<String, Object> value) {
        add(requestLogRows, value);
        return this;
    }
     ...
     * @return 处理结果
     */
    public List<Map<String, Object>> requestLogRows() {
        return requestLogRows;
    }
