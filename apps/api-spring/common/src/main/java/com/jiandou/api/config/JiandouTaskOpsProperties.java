...
public class JiandouTaskOpsProperties {
    ...
    private int generationAsyncThreads = 2;
    ...
    public int getGenerationAsyncThreads() {
        return generationAsyncThreads;
    }

    public void setGenerationAsyncThreads(int generationAsyncThreads) {
        this.generationAsyncThreads = Math.max(1, generationAsyncThreads);
    }
