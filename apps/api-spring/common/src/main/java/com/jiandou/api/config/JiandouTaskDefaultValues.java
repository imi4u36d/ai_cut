...
public final class JiandouTaskDefaultValues {
    ...
    public static final String OUTRO_TEMPLATE = "none";
    public static final String PROMPT_SOURCE = "spring-default";
    public static final String SEEDANCE_QUERY_MODEL = "seedance-1.5-pro";

    private JiandouTaskDefaultValues() {}
}
