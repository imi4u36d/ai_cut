...
public class MybatisPlusConfig {
    ...
    public DataSource dataSource(
        ...
        @Value("${JIANDOU_DB_POOL_MAX_SIZE:6}") int maximumPoolSize,
        @Value("${JIANDOU_DB_POOL_MIN_IDLE:1}") int minimumIdle
    ) {
        ...
        int normalizedMaximumPoolSize = Math.max(1, maximumPoolSize);
        dataSource.setMaximumPoolSize(normalizedMaximumPoolSize);
        dataSource.setMinimumIdle(Math.max(0, Math.min(minimumIdle, normalizedMaximumPoolSize)));
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) {
        ...
        configuration.addMapper(SysCreditAccountMapper.class);
        configuration.addMapper(SysCreditRuleMapper.class);
        configuration.addMapper(SysCreditTransactionMapper.class);
