...
class GlobalApiExceptionHandlerTest {
    ...
    void handleApiExceptionUsesBusinessStatusAndCode() {
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/api/v3/tasks/task_1");
        ...
        assertEquals("/api/v3/tasks/task_1", response.getBody().path());
    ...
    void handleGenerationProviderExceptionReturnsExplicitProviderFailure() {
        MockHttpServletRequest request = new MockHttpServletRequest(
            "POST",
            "/api/v3/workflows/wf_1/clips/1002/keyframes/generate"
        );
    ...
    void handleIllegalArgumentMapsToBadRequest() {
        MockHttpServletRequest request = new MockHttpServletRequest("POST", "/api/v3/uploads/texts");
        ...
        assertEquals("/api/v3/uploads/texts", response.getBody().path());
        assertNotNull(response.getBody().timestamp());
    }
}
